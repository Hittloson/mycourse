...
function Main() {
  return (
    <div className="w-[317px] h-[399px] m-auto text-[#fff] bg-[#1A1B21] font-display">
        <h1 className="text-center pt-[15px] text-3xl font-semibold">Mark Smith</h1>
        <h3 className="text-center text-2xl">Frontend Developer</h3>
        <p className="text-center ">marksmith.gh</p>
